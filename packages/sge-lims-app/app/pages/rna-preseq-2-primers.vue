...
const submitRnaPreseq2Primers = async (data: any[]) => {
    try {
        ...
        const response: { primers: { id: string }[]; insertedCount: number } = await $fetch(`/api/custom/primers/rna-preseq-2-primers/pcr-primer-import`, {
            method: 'POST',
            body: filteredData,
        })
    ...
    <Splitter class="h-full overflow-y-hidden">
        <SplitterPanel :size="50">
            <SmartTable
                ...
                table-name="rna-preseq-2-primers"
                :zodSchema="schemas.rnaPreseq2Primers.select"
         ...
         <SplitterPanel v-if="crudTable.state.showAddForm || crudTable.state.showEditForm || crudTable.state.showMultipleEditForm">
            <RecordsSmartForm
                ...
                submitUrl="/api/rna-preseq-2-primers"
                submitMethod="POST"
            ...
            <RecordsSmartForm
                ...
                selectUrl="/api/rna-preseq-2-primers"
                :recordIds="[crudTable.state.editingRecordId]"
                submitUrl="/api/rna-preseq-2-primers"
                submitMethod="PUT"
                :zodSchema="schemas.rnaPreseq2Primers.update"
                :can-delete="true"
                :fieldConfigs="fieldConfigs"
                :readonlyValues="readonlyValues"
