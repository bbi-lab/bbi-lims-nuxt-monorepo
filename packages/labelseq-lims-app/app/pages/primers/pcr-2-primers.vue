    ...
    <Splitter class="h-full overflow-y-hidden">
        <SplitterPanel :size="50">
            <SmartTable
                ...
                table-name="pcr-2-primers"
                :zodSchema="schemas.pcr2Primers.select"
                title="PCR 2 Primers"
        ...
        <SplitterPanel v-if="crudTable.state.showAddForm || crudTable.state.showEditForm || crudTable.state.showMultipleEditForm">
            <RecordsSmartForm
                ...
                submitUrl="/api/pcr-2-primers"
                submitMethod="POST"
                :zodSchema="schemas.pcr2Primers.insert"
            ...
            <RecordsSmartForm
                ...
                selectUrl="/api/pcr-2-primers"
                :recordIds="[crudTable.state.editingRecordId]"
                submitUrl="/api/pcr-2-primers"
                submitMethod="PUT"
                :zodSchema="schemas.pcr2Primers.update"
                :fieldConfigs="fieldConfigs"
                :readonlyValues="readonlyValues"
                :canDelete="true"
