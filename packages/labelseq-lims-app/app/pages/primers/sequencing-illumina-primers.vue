    ...
    <Splitter class="h-full overflow-y-hidden">
        <SplitterPanel :size="50">
            <SmartTable
                ...
                table-name="sequencing-illumina-primers"
                :zodSchema="schemas.sequencingIlluminaPrimers.select"
                title="Sequencing Illumina Primers"
        ...
        <SplitterPanel v-if="crudTable.state.showAddForm || crudTable.state.showEditForm || crudTable.state.showMultipleEditForm">
            <RecordsSmartForm
                ...
                submitUrl="/api/sequencing-illumina-primers"
                submitMethod="POST"
                :zodSchema="schemas.sequencingIlluminaPrimers.insert"
            ...
            <RecordsSmartForm
                ...
                selectUrl="/api/sequencing-illumina-primers"
                :recordIds="[crudTable.state.editingRecordId]"
                submitUrl="/api/sequencing-illumina-primers"
                submitMethod="PUT"
                :zodSchema="schemas.sequencingIlluminaPrimers.update"
                :readonlyValues="readonlyValues"
                :canDelete="true"
