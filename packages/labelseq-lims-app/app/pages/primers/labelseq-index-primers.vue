    ...
    fullSequence: {
        format: (data: any) => {
            if (data.primerType === 'p7') {
                return LABELSEQ_INDEX_PRIMER_P7_ADAPTER_SEQ + data.indexSeq + LABELSEQ_INDEX_PRIMER_R2_BINDING_SEQ
            } else if (data.primerType === 'p5') {
                return LABELSEQ_INDEX_PRIMER_P5_ADAPTER_SEQ + data.indexSeq + LABELSEQ_INDEX_PRIMER_R1_BINDING_SEQ
            } else {
                return '-'
            }
        },
