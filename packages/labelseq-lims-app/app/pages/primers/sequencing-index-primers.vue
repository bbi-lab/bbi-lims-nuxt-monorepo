    ...
    <Splitter class="h-full overflow-y-hidden">
        <SplitterPanel :size="50">
            <SmartTable
                ...
                table-name="sequencing-index-primers"
                :zodSchema="schemas.sequencingIndexPrimers.select"
                title="Sequencing Index Primers"
        ...
        <SplitterPanel v-if="crudTable.state.showAddForm || crudTable.state.showEditForm || crudTable.state.showMultipleEditForm">
            <RecordsSmartForm
                ...
                submitUrl="/api/sequencing-index-primers"
                submitMethod="POST"
                :zodSchema="schemas.sequencingIndexPrimers.insert"
            ...
            <RecordsSmartForm
                ...
                selectUrl="/api/sequencing-index-primers"
                :recordIds="[crudTable.state.editingRecordId]"
                submitUrl="/api/sequencing-index-primers"
                submitMethod="PUT"
                :zodSchema="schemas.sequencingIndexPrimers.update"
                :readonlyValues="readonlyValues"
                :canDelete="true"
