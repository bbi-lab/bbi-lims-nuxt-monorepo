...
const columnDefs: ColumnDefinitions = {
    ...
    haCloningExperiment: {
        ...
        type: 'element',
        element: (data: any) => {
            const href = data.haPuc19GibsonProduct?.haPuc19PcrProduct?.haPcrProduct?.haCloningExperiment?.id ? `/ha-cloning-experiments?id=${data.haPuc19GibsonProduct.haPuc19PcrProduct.haPcrProduct.haCloningExperiment.id}` : null
