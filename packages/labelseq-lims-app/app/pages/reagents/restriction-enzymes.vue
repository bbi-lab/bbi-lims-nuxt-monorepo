    ...
    <Splitter class="h-full overflow-y-hidden">
        <SplitterPanel :size="50">
            <SmartTable
                ...
                table-name="restriction-enzymes"
                :zodSchema="schemas.restrictionEnzymes.select"
        ...
        <SplitterPanel v-if="crudTable.state.showAddForm || crudTable.state.showEditForm || crudTable.state.showMultipleEditForm">
            <RecordsSmartForm
                ...
                submitUrl="/api/restriction-enzymes"
                submitMethod="POST"
                :zodSchema="schemas.restrictionEnzymes.insert"
            ...
            <RecordsSmartForm
                ...
                selectUrl="/api/restriction-enzymes"
                :recordIds="[crudTable.state.editingRecordId]"
                submitUrl="/api/restriction-enzymes"
                submitMethod="PUT"
                :zodSchema="schemas.restrictionEnzymes.update"
                :readonlyValues="readonlyValues"
                :canDelete="true"
